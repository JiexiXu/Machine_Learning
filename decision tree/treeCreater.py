...
if __name__ == '__main__':
    ...
    title3 = "第4章：决策树 - 4.3输出" 
    data_path = r'/Users/xujiexi/Desktop/机器学习/作业9/data/watermelon3_0_Ch.csv'
    data = pd.read_csv(data_path, index_col=0)
    
    tree = DecisionTree(criterion='infogain')
    tree.fit(data.iloc[:, :8], data.iloc[:, 8])
    treePlottter.create_plot(tree.tree_, title3)
